    ...
    <div className="flex min-h-screen flex-col">
              ...
              <div className="flex flex-col justify-center space-y-4">
                <div className="space-y-2">
                  ...
                  <p className="max-w-[600px] text-white/80 md:text-xl">
                    Protect your systems with our advanced AI that detects known and unknown threats in real-time.
                  </p>
                </div>
                <div className="flex flex-col gap-2 min-[400px]:flex-row">
                  <Button size="lg" className="gap-2 bg-accent text-black hover:bg-accent/90">
              ...
              <div className="mx-auto flex w-full items-center justify-center">
                <Card className="w-full border-0 shadow-lg">
                  <CardHeader>
                    ...
                    <CardDescription>Upload a file to check for malware</CardDescription>
                  </CardHeader>
                  <CardContent>
        ...
        <section className="w-full py-12 md:py-24 lg:py-32">
          <div className="container px-4 md:px-6">
            <div className="mx-auto flex max-w-[58rem] flex-col items-center justify-center gap-4 text-center">
              <h2 className="text-3xl font-bold leading-[1.1] sm:text-3xl md:text-5xl">Advanced Protection Features</h2>
              <p className="max-w-[85%] leading-normal text-muted-foreground sm:text-lg sm:leading-7">
                Our AI-powered malware detection system provides comprehensive protection against various threats.
              </p>
            </div>
        ...
        <section className="w-full py-12 md:py-24 lg:py-32 custom-blue-overlay">
          <div className="container px-4 md:px-6">
            <div className="mx-auto flex max-w-[58rem] flex-col items-center justify-center gap-4 text-center">
              ...
              <p className="max-w-[85%] leading-normal text-muted-foreground sm:text-lg sm:leading-7">
                Our AI-powered system uses advanced machine learning to detect malware with high accuracy.
              </p>
            </div>
            <div className="mx-auto grid max-w-5xl items-center gap-6 py-12 lg:grid-cols-2 lg:gap-12">
              ...
              <div className="mx-auto flex w-full items-center justify-center">
                <Tabs defaultValue="upload" className="w-full max-w-md">
                  ...
                  <TabsContent value="upload" className="border rounded-lg p-4 mt-2 border-primary/20">
                  ...
                  <TabsContent value="analyze" className="border rounded-lg p-4 mt-2 border-primary/20">
                    <div className="flex flex-col items-center justify-center space-y-4 p-4">
                  ...
                  <TabsContent value="results" className="border rounded-lg p-4 mt-2 border-primary/20">
                    <div className="flex flex-col items-center justify-center space-y-4 p-4">
                      <div className="flex items-center justify-center">
                        <AlertTriangle className="h-16 w-16 text-red-500" />
                      </div>
                      <h3 className="text-lg font-bold text-red-500">Malware Detected</h3>
                      <p className="text-center text-sm text-muted-foreground">
                        Trojan detected in file. We recommend immediate deletion.
                      </p>
                    </div>
                  </TabsContent>
                </Tabs>
      ...
      <footer className="w-full border-t py-6 bg-primary text-white">
        <div className="container flex flex-col items-center justify-between gap-4 md:flex-row">
          ...
          <p className="text-center text-sm text-white/70">© 2024 MalwareGuard AI. All rights reserved.</p>
          <div className="flex gap-4">
            <Link to="#" className="text-sm text-white/70 underline underline-offset-4 hover:text-white">
              Terms
            </Link>
            <Link to="#" className="text-sm text-white/70 underline underline-offset-4 hover:text-white">
              Privacy
